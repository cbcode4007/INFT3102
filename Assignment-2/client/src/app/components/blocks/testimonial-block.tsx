...
export function TestimonialBlock({ block }: { block: TestimonialBlock }) {
  ...
  return (
    <figure className="relative bg-gray-100 rounded-lg overflow-hidden my-6">
      <div className="grid grid-cols-1 md:grid-cols-3">
        ...
        <div className="p-8 col-span-2 flex flex-col justify-center bg-dark">
          ...
          <figcaption className="font-semibold text-white mt-2">
            {block.authorName}
          </figcaption>
        </div>
      </div>
